...
class _ApiService implements ApiService {
  ...
  @override
  Future<SpecializationResponse> getAllSpecialization(String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<SpecializationResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    ...
    final value = SpecializationResponse.fromJson(_result.data!);
    return value;
  }
